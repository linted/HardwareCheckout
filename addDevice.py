...
parser.add_argument('-u', '--username', dest='username', help="User name", required=False)
parser.add_argument('-p','--password', dest='password', help="User password", required=False)
parser.add_argument('-t', '--type', dest='devtype', help="Device type", required=False)
parser.add_argument('-i', '--ini', dest='inifile', help='Ini file containing list of users', required=False)
